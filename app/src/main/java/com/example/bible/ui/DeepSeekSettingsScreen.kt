...
fun DeepSeekSettingsScreen(
    ...
    val savedKey by viewModel.deepSeekApiKey.collectAsStateWithLifecycle()
    val keyTest by viewModel.deepSeekKeyTest.collectAsStateWithLifecycle()
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                TextButton(onClick = { viewModel.setDeepSeekApiKey(draft) }) {
                    Text(stringResource(R.string.main_settings_deepseek_save))
                }
                TextButton(
                    onClick = { viewModel.testDeepSeekKey(draft) },
