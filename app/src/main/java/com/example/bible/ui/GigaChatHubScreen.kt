    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = { Text(stringResource(R.string.gigachat_hub_title)) },
                navigationIcon = {
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.gigachat_hub_hint),
            ...
            GigaChatHubButton(
                ...
                title = stringResource(R.string.gigachat_hub_settings),
                description = stringResource(R.string.gigachat_hub_settings_desc),
